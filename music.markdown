...
<audio src="{{ site.github.url }}/clips/FlyMeToTheMoon.mp3" controls="controls">
Your browser does not support the audio element.
</audio>
* [Bleeding Love/No One - Leona Lewis/Alicia Keys](#)  
<audio src="{{ site.github.url }}/clips/BleedingLove.mp3" controls="controls">
Your browser does not support the audio element.
</audio>
* [Spaceman - The Killers](#)  
<audio src="{{ site.github.url }}/clips/Spaceman.mp3" controls="controls">
Your browser does not support the audio element.
</audio>
* [The Scientist - Coldplay](#)  
<audio src="{{ site.github.url }}/clips/TheScientist.mp3" controls="controls">
Your browser does not support the audio element.
</audio>
* [Hide and Seek - Imogen Heap](#)  
<audio src="{{ site.github.url }}/clips/HideAndSeek.mp3" controls="controls">
Your browser does not support the audio element.
</audio>
* [Creep - Radiohead](#)  
<audio src="{{ site.github.url }}/clips/Creep.mp3" controls="controls">
Your browser does not support the audio element.
</audio>
* [Somebody to Love - Queen](#)  
<audio src="{{ site.github.url }}/clips/Somebody.mp3" controls="controls">
Your browser does not support the audio element.
</audio>
* [Under the Bridge - Red Hot Chili Peppers](#)  
<audio src="{{ site.github.url }}/clips/UnderTheBridge.mp3" controls="controls">
Your browser does not support the audio element.
</audio>
* [Chocolate - Snow Patrol](#)  
<audio src="{{ site.github.url }}/clips/Chocolate.mp3" controls="controls">
Your browser does not support the audio element.
</audio>
* [Crazy - Seal](#)  
<audio src="{{ site.github.url }}/clips/Crazy.mp3" controls="controls">
Your browser does not support the audio element.
</audio>
* [Dream a Little Dream of Me - The Mamas and the Papas](#)  
<audio src="{{ site.github.url }}/clips/Dream.mp3" controls="controls">
Your browser does not support the audio element.
</audio>
* [Here With Me - Dido](#)  
<audio src="{{ site.github.url }}/clips/Dido.mp3" controls="controls">
Your browser does not support the audio element.
</audio>
* [I'm Beginning to See the Light - Duke Ellington](#)  
<audio src="{{ site.github.url }}/clips/ToSee.mp3" controls="controls">
Your browser does not support the audio element.
</audio>
* [Total Eclipse of the Heart - Bonnie Tyler/Nikki French](#)  
<audio src="{{ site.github.url }}/clips/Total.mp3" controls="controls">
Your browser does not support the audio element.
</audio>
